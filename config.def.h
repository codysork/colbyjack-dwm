...
static const char *fonts[]          = { "monospace:size=18", "NotoColorEmoji:pixelsize=18:antialias=true" };
static const char dmenufont[]       = "NotoColorEmoji:pixelsize=12:antialias=true";
